...
import { getActiveShipments } from "../../../services/shipper/shipments.service";
import { toast } from "react-hot-toast";

export function useShipperActiveShipments(activeTab = "assigned") {
  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["activeShipments", activeTab],
    queryFn: async () => {
